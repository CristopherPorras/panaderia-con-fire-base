...
firebase_admin.initialize_app(cred, {
    ...
    'projectId': 'base-de-datos-panaderia-f4398',  # Asegúrate de que el ID del proyecto esté correcto
    'storageBucket': 'base-de-datos-panaderia-f4398.firebasestorage.app',  # Agrega esto si también estás usando Firebase Storage
})

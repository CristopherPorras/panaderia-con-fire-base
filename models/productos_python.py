...
firebase_admin.initialize_app(cred, {
    'databaseURL': 'https://delicias-f0e8d-default-rtdb.firebaseio.com/',
    'projectId': 'delicias-f0e8d',  # Asegúrate de que el ID del proyecto esté correcto
    'storageBucket': 'delicias-f0e8d.appspot.com',  # Agrega esto si también estás usando Firebase Storage
})
